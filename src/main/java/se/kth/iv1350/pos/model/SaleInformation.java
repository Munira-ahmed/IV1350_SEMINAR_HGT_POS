...
/**
 * This is the SaleInformation class, containing methods of getting information
 * of the current sale.
 * It has discounts DiscountDTO[], double totalPrice, HashMap<ItemDTO, Integer>
 * soldItems as attibutes.
 */
public class SaleInformation {
     ...
     * Set the totalPrice = 0 when the sale starts and the discounts, soldItems are
     ...
     * 
     * @return discounts The DiscoutDTO[] which contains all eligible discounts of a
     *         customer.
     */
     ...
     * 
     * @return soldItems The HashMap<ItemDTO, Integer> which contains all the
     *         entered items and their sold quantity for the current sale.
     */
     ...
     * If the item is valid(can be found in inventory), the itemDTO will be added in
     * the soldItems.
     * If the item is already existed on soldItems list, the quantity of the sold
     * item will be added
     ...
     * @throws ItemNotFoundException when the entered item identifier can not be
     *                               found in inventory.
     */
    public void addItem(int identifier, int quantity, ExternalInventorySystem externalInventorySystem)
        ...
        if (toBeAddedItem == null) {
            throw new ItemNotFoundException(
                    "The item " + Integer.toString(identifier) + " does not exist in the inventory.");
            // System.out.println("The item with identifier " + Integer.toString(identifier)
            // + " is invald.");
        }
     ...
     * 
     * @param customerId The int which will be entered for getting eligible
     *                   discounts of the customer.
     * @return totalPrice The double of total price after that eligible discounts
     *         are applied.
     */
